...
const IconLiaotian: FunctionComponent<Props> = ({ size = 18, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE;

  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      <path
        d="M948.8896 315.5968c-14.1312 0-25.6 11.4688-25.6 25.6v12.2368c0 14.1312 11.4688 25.6 25.6 25.6s25.6-11.4688 25.6-25.6v-12.2368c0-14.1312-11.4688-25.6-25.6-25.6z"
      ...
      />
      <path
        d="M263.9872 559.616a38.3488 36.5568 90 1 0 73.1136 0 38.3488 36.5568 90 1 0-73.1136 0Z"
        fill={getIconColor(color, 2, '#44454A')}
      />
      <path
        d="M404.8896 559.616a38.3488 36.5568 90 1 0 73.1136 0 38.3488 36.5568 90 1 0-73.1136 0Z"
        fill={getIconColor(color, 3, '#44454A')}
      />
      <path
        d="M547.072 559.616a38.3488 36.5568 90 1 0 73.1136 0 38.3488 36.5568 90 1 0-73.1136 0Z"
