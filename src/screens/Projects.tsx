...
const Projects = ({ active }: ScreenProps) => {
  ...
  const checkActive = (category: Categories, currentStatus: Categories) =>
    category === currentStatus ? "active" : "";
    ...
    >
      ...
      <section className="projects">
        ...
        <ul className="project-list">
          {projects
            .filter(project =>
              selectedCategory === "All" ? true : project.type.includes(selectedCategory)
            )
            .map(project => (
              <li
